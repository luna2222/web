...
<body>
	...
	<table width="600" cellpadding="0" cellspacing="0" border="1">
		...
		<tr>
			<!--  <td colspan="3"><a href="write_view.do?column=bTitle&word=<%=session.getAttribute("bTitle")%>">글작성</a></td>-->
		...
		<tr>
			...
			<c:otherwise>
				<a href="search.do?page=1&column=bTitle&word=${page.boardTitle}">[ &lt;&lt; ]</a>
			</c:otherwise>
			</c:choose>
			<!-- 이전 -->
			<c:choose>
			...
			<c:otherwise>
				<a href="search.do?page=${page.curPage - 1}&column=bTitle&word=${page.boardTitle}">[ &lt; ]</a>
			</c:otherwise>
			</c:choose>
			...
			<c:forEach var="fEach" begin="${page.startPage}" end="${page.endPage}" step="1">
				...
				<c:otherwise>
					<a href="search.do?page=${fEach}&column=bTitle&word=${page.boardTitle}">[ ${fEach} ]</a>&nbsp;
				</c:otherwise>
				</c:choose>
			</c:forEach>
			...
			<c:otherwise>
				<a href="search.do?page=${page.totalPage}&column=bTitle&word=${page.boardTitle}">[&gt;&gt;]</a>
			</c:otherwise>
			</c:choose>
		</tr>
	</table>
